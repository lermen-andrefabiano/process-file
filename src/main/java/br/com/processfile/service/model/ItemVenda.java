...
public class ItemVenda extends AbstractArquivo implements Serializable {
	...
	public ItemVenda addItemVenda(String itemLine) {
		...
		this.itemId = splitItemLine[0] != null ? new Long(splitItemLine[0]) : null;
		this.quantidade = splitItemLine[1] != null ? new BigDecimal(splitItemLine[1]) : BigDecimal.ZERO;
		this.preco = splitItemLine[2] != null ? new BigDecimal(splitItemLine[2]) : BigDecimal.ZERO;
